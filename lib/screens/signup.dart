...
class SignUpPage extends StatefulWidget {
  ...
  SignUpPage({super.key, this.title});
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _submitButton() {
    ...
    return GestureDetector(
      onTap:()async{
        String output = await auth.signUp(username: _usernameController.text, email:_emailController.text, password:_passwordController.text);
        print(output);
